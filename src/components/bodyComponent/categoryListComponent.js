...
class CategoryListComponent extends Component {
    ...
    componentDidMount() {
        CategoryBoardsAPI.getCategoryBoards(this.state.category, this.state.p_num).then((res) => {
            this.setState({
    ...
    listBoard(p_num) {
        ...
        CategoryBoardsAPI.getCategoryBoards(this.state.category, p_num).then((res) => {
            console.log(res);
            this.setState({ 
                p_num: res.data.pageNum,
                paging: res.data,
